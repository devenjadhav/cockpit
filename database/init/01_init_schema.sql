-- Create database schema for Daydream Portal
-- This mirrors the Airtable structure for local caching
...
CREATE INDEX idx_events_triage_status ON events(triage_status);
CREATE INDEX idx_events_location ON events(location);
CREATE INDEX idx_events_event_format ON events(event_format);
...
GRANT CONNECT ON DATABASE daydream_portal TO readonly_user;
